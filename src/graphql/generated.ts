...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', id: string, title: string, description?: string | null, videoId: string, teacher?: { __typename?: 'Teacher', bio: string, name: string, avatarURL: string } | null } | null };
